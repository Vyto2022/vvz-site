...
**Version:** v8 — trust catalysis + sticky contact
...
### 4) Test
Open the site, submit the form. You should see a new row in the **Leads** sheet (timestamp, name, email, phone, city, project, message).
